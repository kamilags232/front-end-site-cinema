...
(cd_sala INT AUTO_INCREMENT PRIMARY KEY,
sala int,
capacidade int,
tp_sala char(5),
dublagem char(20));
...
(cd_filme INT AUTO_INCREMENT PRIMARY KEY,
filme char(50),
duracao time,
...
(cd_sessao INT AUTO_INCREMENT PRIMARY KEY,
sessao char(50),
data_hora datetime,
...
(nr_recibo INT AUTO_INCREMENT PRIMARY KEY,
...
(cd_ingresso INT AUTO_INCREMENT PRIMARY KEY,
